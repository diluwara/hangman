...
# Static files (React build files)
STATICFILES_DIRS = [
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY') or 'django-insecure-8oz3mcw*ard(&tqvyyaiyv&ygz6^@t4$xaj1k#3u^0q0c)4(0w'
...
# For serving media files (if you have any):
MEDIA_URL = '/'
